...
def init(cmseek_dir, report_dir=""):
    ...
    cmseek.info('Updating WP-Ateck result index...')
    if os.path.isdir(cmseek_dir):
            ...
            for result_dir in result_dirs:
                ...
                if os.path.isfile(scan_file):
                    try:
                        ...
                        cmseek.statement('Skipping invalid WP-Ateck result: ' + scan_file)
            # Write index
        ...
        cmseek.error('Invalid WP-Ateck directory passed!')
        return [0, 'WP-Ateck directory does not exist']
